...
//		System.out.println("Sortert listeAvString: " + listeAvString);
		...
		//		Sammenligner<Person> paaFornavn = new Sammenligner<>() {
		//			@Override
		...
		Sammenligner<Person> paaFornavn = (a,b) -> a.fornavn().compareTo(b.fornavn());
		
		Utvalgssortering.sorter(listeAvPersoner, paaFornavn);
		...
		Sammenligner<Person> paaFodselsaar = (a,b) -> a.fodselsaar() - b.fodselsaar();
		
		Utvalgssortering.sorter(listeAvPersoner, paaFodselsaar);
		System.out.println("Sortert på fødselsår: " + listeAvPersoner);

		//3. Sortere liste av personer på etternavn = default sortering
